package com.github.helpers.annotations;
    ...
    public static class LocalExecutionCondition implements ExecutionCondition {
        ...
        public ConditionEvaluationResult evaluateExecutionCondition(ExtensionContext context) {
            return com.codeborne.selenide.Configuration.remote == null
                    ...
                    ? ConditionEvaluationResult.enabled("Тест включен в локальном исполнении")
                    : ConditionEvaluationResult.disabled("Тест отключен при удаленном выполнении");
        }
    }
}
